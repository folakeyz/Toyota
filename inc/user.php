...
echo '<span class="text-danger">Password do not match</span><br>';
    ...
    $sql = "INSERT INTO `users`(`fname`,`lname`,`mobile`,`email`,`role`,`created`,`time`,`uname`,`pwd`,`location`,`createdby`)VALUES('$fname','$lname','$mobile','$email','$role','$cdate','$ctime','$uname','$hash','$location','$cby')";
