...
<div class="muser">
   <div class="row">
      <div class="col-md-6">
      <h6 class="alert alert-success text-center" style="padding:3px">Edit User</h6>
            <p class="upload-info" style="font-size:11px;">
           </p>
      <form method="post" action="inc/euser.php" enctype="multipart/form-data" autocomplete="off">
      <div class="container">
      <div class="row">
        <div class="form-group col-md-6">
                <label>First Name</label>
           <input type="text" name="fname" class="form-control" placeholder="First Name" id="bio-fname" value="<?=$rows['fname'];?>">
       </div>   
        <div class="form-group col-md-6">
                <label>Last Name</label>
           <input type="text" name="lname" class="form-control" placeholder="Last Name" id="bio-lname" value="<?=$rows['lname'];?>">
       </div>   
          <div class="form-group col-md-6">
                <label>Mobile Number</label>
           <input type="number" name="mobile" class="form-control" placeholder="Mobile Number" id="bio-mobile" maxlength="11" value="<?=$rows['mobile'];?>">
       </div>
           <div class="form-group col-md-6">
                 <label>Email</label>
           <input type="email" name="email" class="form-control" placeholder="Email Address" id="bio-email" value="<?=$rows['email'];?>">
       </div> 
       <div class="form-group col-md-6">
           ...
           <input type="hidden" name="id" class="form-control" value="<?=$rows['id'];?>" id="id">
       </div>
        <div class="form-group col-md-6">
          <label>Username</label>
           <input type="text" name="uname" class="form-control" placeholder="Username" id="bio-uname" value="<?=$rows['uname'];?>">
       </div>
        <div class="form-group col-md-6">
             ...
             $(document).ready(function() {
                 $("form").submit(function(event){
                    event.preventDefault();
                     ...
                     $(".upload-info").load("inc/euser.php", {
                         fname: fname,
                         lname: lname,
                         mobile: mobile,
                         email: email,
